...
const Footer = () => {
  return (
    <footer className='bg-[#232536] w-full p-6 md:px-16 md:py-10 flex flex-col gap-8 justify-between'>
      
      <div className="flex flex-col md:flex-row justify-between items-center gap-4">
        <Logo />
        <div className="flex flex-wrap justify-center gap-5 md:gap-6 text-sm font-medium">
          <Link className="text-white hover:opacity-80 transition-opacity" href="">Home</Link>
          <Link className="text-white hover:opacity-80 transition-opacity" href="">Blog</Link>
          <Link className="text-white hover:opacity-80 transition-opacity" href="">About us</Link>
          <Link className="text-white hover:opacity-80 transition-opacity" href="">Contact us</Link>
        </div>
      </div>
