...
const Footer = () => {
  ...
  return (
    <footer id="footer" className='bg-[#232536] w-full p-6 md:px-16 md:py-10 flex flex-col gap-8 justify-between'>
      ...
      <div className="bg-[#2A2B39]/60 rounded-sm py-10 px-6 md:px-12 flex flex-col lg:flex-row justify-between items-center gap-6">
        ...
        <div className="flex flex-col sm:flex-row w-full lg:w-auto gap-3 items-center">
          <input className="bg-white text-gray-700 text-sm w-full sm:w-80 h-12 rounded-md px-4 outline-none placeholder:text-gray-400" type="text" placeholder="example@email.com" />
