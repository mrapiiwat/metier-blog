            ...
            {navLinks.map((link) => {
              ...
              return (
                <Link
                  key={link.name}
                  href={link.path}
                  className={`${isActive ? 'text-white font-bold' : 'text-gray-400 hover:text-white'} transition-all`}
                >
                  {link.name}
                </Link>
              );
          ...
          {navLinks.map((link) => {
            ...
            return (
              <Link
                ...
                className={`${isActive ? 'text-white font-bold' : 'text-gray-400'} block text-sm`}
              >
                {link.name}
              </Link>
            );
