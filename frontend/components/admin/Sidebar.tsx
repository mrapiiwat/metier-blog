  ...
  <aside className="flex flex-col gap-4">
    ...
    <div className="bg-white border border-gray-100 rounded-2xl p-5 text-[12px] space-y-3">
      <div className="flex justify-between">
        <span className="text-gray-400 flex items-center gap-2"><FiCalendar size={13}/> สร้างเมื่อ</span> 
        <span className="font-semibold">1 มิ.ย. 2568</span>
      </div>
      <div className="flex justify-between">
        <span className="text-gray-400 flex items-center gap-2"><FiClock size={13}/> แก้ไขล่าสุด</span> 
        <span className="font-semibold">19 มิ.ย. 2568</span>
      </div>
      <div className="flex justify-between">
        <span className="text-gray-400 flex items-center gap-2"><FiHash size={13}/> จำนวนคำ</span> 
