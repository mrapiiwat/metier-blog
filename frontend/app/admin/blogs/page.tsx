...
const ManageBlogs = () => {
  const [blogs, setBlogs] = useState<BlogItem[]>([
    { id: 1, title: 'Classic Revival: Revisiting Iconic Cars', slug: 'classic-revival', date: '2026-06-18', views: 1250, isPublished: true },
    { id: 2, title: 'The Future of Electric Vehicles Strategy', slug: 'future-ev', date: '2026-06-15', views: 840, isPublished: false },
    { id: 3, title: 'Top 10 Maintenance Tips for Old Cars', slug: 'maintenance-tips', date: '2026-06-10', views: 3200, isPublished: true },
    { id: 4, title: 'Why 90s JDM Cars Are Increasing In Value', slug: '90s-jdm', date: '2026-06-08', views: 4500, isPublished: true },
    { id: 5, title: 'How to Choose the Right Tires for Your Car', slug: 'choose-right-tires', date: '2026-06-05', views: 0, isPublished: false },
  ])
